...
// AFHTTPSig
#define COCOAPODS_POD_AVAILABLE_AFHTTPSig
#define COCOAPODS_VERSION_MAJOR_AFHTTPSig 1
#define COCOAPODS_VERSION_MINOR_AFHTTPSig 0
#define COCOAPODS_VERSION_PATCH_AFHTTPSig 1
